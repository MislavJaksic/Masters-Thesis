...
\node[](broker_2) at (2,0) {...};
\node[rounded_square](broker_3) at (4,0) {Posrednik};
\node[rounded_square](zoo_1) at (6,0) {Nadzornik};

\node[](false_broker) at (8,0) {...};

\node[rounded_square](broker_4) at (10,0) {Posrednik};
\node[](broker_5) at (12,0) {...};
\node[rounded_square](broker_6) at (14,0) {Posrednik};
\node[rounded_square](zoo_2) at (16,0) {Nadzornik};

\node[rounded_square](jmx_1) at (0,-3) {JMX};
\node[](jmx_2) at (2,-3) {...};
\node[rounded_square](jmx_3) at (4,-3) {JMX};
\node[rounded_square](zk_1) at (6,-3) {ZK};

\node[rounded_square](jmx_4) at (10,-3) {JMX};
\node[](jmx_5) at (12,-3) {...};
\node[rounded_square](jmx_6) at (14,-3) {JMX};
\node[rounded_square](zk_2) at (16,-3) {ZK};

\node[rounded_square](task_1) at (6,-4.5) {Connect Task};
\node[](task_2) at (8,-4.4) {...};
\node[rounded_square](task_3) at (10,-4.5) {Connect Task};

\node[rounded_square](connector) at (8,-6) {Connect Connector};

\node[rounded_square](kafka) at (8,-7.5) {Posrednik};

\node[fit_square, fit=(broker_1) (broker_2) (broker_3) (zoo_1)] (cluster_1) {};
\node[anchor=north west] at (cluster_1.north west) {Kafka grozd 1};

\node[fit_square, fit=(broker_4) (broker_5) (broker_6) (zoo_2)] (cluster_2) {};
\node[anchor=north west] at (cluster_2.north west) {Kafka grozd 2};

\node[fit_square, fit=(jmx_1) (jmx_2) (jmx_3) (zk_1) (jmx_4) (jmx_5) (jmx_6) (zk_2) (task_1) (task_2) (task_3) (connector) (kafka)] (cluster_3) {};
\node[anchor=south west] at (cluster_3.south west) {Kafka grozd 3};
