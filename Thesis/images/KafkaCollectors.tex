...
\node[rounded_square](jmx_1) at (1,-2.5) {JMX};
\node[rounded_square](reporter_1) at (3,-2.5) {Mjerač};
\node[rounded_square](reporter_2) at (9,-2.5) {Mjerač};
\node[rounded_square](jmx_2) at (11,-2.5) {JMX};

\node[rounded_square](zk_1) at (5,-3.5) {ZK};
\node[rounded_square](zk_2) at (7,-3.5) {ZK};
...
\draw[dashed_arrow](kafka_1) to [] node[auto]{} (collector_1);
\draw[dashed_arrow](kafka_2) to [] node[auto]{} (collector_2);
