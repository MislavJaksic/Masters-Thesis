...
\node[rounded_square](zookeeper_kafka) at (0,-3) {ZooKeeper Kafka};
\node[rounded_square](jmx_client) at (3,-3) {JMX Client};
...
\node[rounded_square](zk) at (0,-6.5) {ZK};
\node[rounded_square](jmx) at (3,-6.5) {JMX};
...
\node[anchor=north west] at (mjerac.north west) {Mjerač};
