...
Nadzire se sustav koji razgovara koristeci siguran intranet
Mrezi ili programima se moze dogoditi ne bizantski ispad
Postoji vise od sto Kafka posrednika i vise of deset Kafka grozdova
Posrednici nisu na istom računalu
Kafka grozdovi i posrednici mogu se upaliti i ugasiti u bilo kojem trenutku

\subsection{Zahtjevi}

Nadzornik mora raditi bez instalacije programa
Nadzornik šalje nadzirane vrijednosti svake sekunde ili češće
Nadzornik zapisuje nadzirane vrijednosti u Kafka temu
Nadzornik mora samostalno pronaći novonastale Kafka grozdove i posrednike
Nadzornik mora dostaviti nadzirane vrijednosti s najmanjim mogućim zakasnjenjem
