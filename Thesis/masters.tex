...
Poglavlje 2 uspoređuje predstavnike sustava za raspodijeljenu obradu podataka, poglavlje 3 opisuje zahtjeve i pretpostavke, poglavlje 4 uspoređuje postojeća rješenja s specifikacijom problema, poglavlje 5 opisuje arhitekturu i poglavlje 6 opisuje izvedbu.
...
\section{Izvedba klase}

Klase su imenice gdje svaka ima samo jednu disjunktnu dužnost.
...
Klase fasade pojednostavljuju korištenje stranih biblioteka. Strane biblioteke imaju klase od kojih rješenje koristi samo mali podskup svih funkcija. Fasade omotaju funkcije zbog lakoće korištenja, izmjena i izolacije od promjena strane biblioteke.
...
Funkcije rade samo jednu stvar. Naziv funkcije definira sto je "jedna stvar". Korisničke funkcije koje pozivaju više izvršnih funkcija rade jednu stvar na visokoj razini apstrakcije, dok izvršne funkcije rade jednu stvar na razini izvedbe.
...
Izvedba: pokazi na primjeru u svom programu gdje je to istina
