...
Apache Kafka je popularni alat za raspodijeljenu obradu tokova podataka. !CITATI opisuju primjenu, arhitekturu i izvedbu Kafke. Kafka moze sluziti kao posrednik u razgovoru izmedu procesa, kao sakupljac mreznih aktivnosti ili obradivac dogadaja. Arhitektura Kafke je temeljen na modelu objavi/pretplati, te se sastoji od posluziteljskog programa posrednika i kornisnickih programa pretplatnika i objavljivaca. Poruke Kafka zapisuje u teme koju su podijeljene na pretince. Sto je vise pretinaca to je veci protok poruka kroz temu. Pretinci se mogu umnoziti da se izbjegne gubitak poruka nakon ispada posrednika.
